"""
Django settings for recipe_exchange project.
...
SECRET_KEY = 'django-insecure-cg!7yp+e1!&&re67s+%fph7wzkk=a^my-43o-+-n%h*we_^(pw'
...
INSTALLED_APPS = [
    ...
    'recipe_exchange.accounts',
    'recipe_exchange.main',
...
ROOT_URLCONF = 'recipe_exchange.urls'
...
WSGI_APPLICATION = 'recipe_exchange.wsgi.application'
